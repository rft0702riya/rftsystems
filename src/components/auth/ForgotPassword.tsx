  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-900 via-purple-900 to-indigo-900 flex items-center justify-center p-4 pt-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/4 left-1/4 w-56 h-56 bg-gradient-to-r from-pink-400 to-orange-400 rounded-full opacity-20 blur-3xl animate-pulse" />
        <div
          className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-gradient-to-r from-cyan-400 to-blue-400 rounded-full opacity-15 blur-3xl animate-pulse"
        ...
        <div
          className="absolute bottom-16 left-16 w-14 h-14 bg-gradient-to-r from-orange-300 to-pink-300 rounded-full opacity-20 animate-bounce"
      ...
      >
        <div className="backdrop-blur-2xl bg-white bg-opacity-10 rounded-2xl shadow-2xl border border-white border-opacity-20 p-6 relative overflow-hidden">
          <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-pink-400 via-orange-400 to-pink-400 opacity-30 blur-sm animate-pulse" />
            ...
            {!isSuccess ? (
              ...
              <div>
                ...
                <div className="text-center mb-6">
                  <div className="w-16 h-16 mx-auto bg-gradient-to-r from-orange-400 to-pink-400 rounded-full flex items-center justify-center shadow-lg animate-bounce mb-4">
                    <div className="w-8 h-8 bg-white rounded-full opacity-30 animate-pulse" />
                  </div>
                  <h1 className="text-3xl font-bold bg-gradient-to-r from-orange-300 to-pink-300 bg-clip-text text-transparent mb-2 animate-fade-in">
                    Forgot Password?
                  </h1>
                ...
                <div className="space-y-4">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-white bg-opacity-10 border border-white border-opacity-30 rounded-xl text-white placeholder-gray-300 focus:outline-none focus:border-orange-400 focus:bg-opacity-15 transition-all duration-300 ${
                        focusedField === 'email' ? 'transform scale-105 shadow-lg shadow-orange-500/20' : ''
                      }`}
                      placeholder="Enter your email address"
                      required
                    />
                    <div
                      className={`absolute inset-0 rounded-xl bg-gradient-to-r from-orange-400 to-pink-400 opacity-0 -z-10 blur transition-all duration-300 ${
                  ...
                  <button
                    ...
                    disabled={isLoading}
                    className="w-full py-3 bg-gradient-to-r from-orange-500 to-pink-500 text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:shadow-orange-500/30 transform hover:scale-105 transition-all duration-300 disabled:opacity-70 relative overflow-hidden group"
                  >
              ...
              <div className="text-center animate-fade-in">
                <div className="w-20 h-20 mx-auto bg-gradient-to-r from-green-400 to-emerald-400 rounded-full flex items-center justify-center shadow-lg animate-bounce mb-6">
                ...
                <div className="space-y-4">
                  <button
                    onClick={resetForm}
                    className="w-full py-3 bg-gradient-to-r from-orange-500 to-pink-500 text-white font-bold rounded-xl shadow-lg hover:shadow-xl hover:shadow-orange-500/30 transform hover:scale-105 transition-all duration-300"
                  >
